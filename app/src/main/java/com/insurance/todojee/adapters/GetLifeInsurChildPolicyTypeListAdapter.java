...
public class GetLifeInsurChildPolicyTypeListAdapter extends RecyclerView.Adapter<GetLifeInsurChildPolicyTypeListAdapter.MyViewHolder> {

    private List<PolicyTypeListPojo.Policy_details> resultArrayList;
    private Context context;

    public GetLifeInsurChildPolicyTypeListAdapter(Context context, List<PolicyTypeListPojo.Policy_details> resultArrayList) {
