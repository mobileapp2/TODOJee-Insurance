...
public class GetGeneralInsurParentPolicyTypeListAdapter extends RecyclerView.Adapter<GetGeneralInsurParentPolicyTypeListAdapter.MyViewHolder> {

    private List<PolicyTypeListPojo> resultArrayList;
    private Context context;

    public GetGeneralInsurParentPolicyTypeListAdapter(Context context, List<PolicyTypeListPojo> resultArrayList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (policyDetails.getPolicy_details().size() != 0) {
            ...
            holder.rv_policytypelist.setAdapter(new GetGeneralInsurChildPolicyTypeListAdapter(context, policyDetails.getPolicy_details()));
        } else {
