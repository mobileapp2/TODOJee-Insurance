...
public class LifeInsurePolicyType_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_lifeinsure_policytype, container, false);
        context = getActivity();
        init(rootView);
        getSessionData();
        setDefault();
...
//                shimmer_view_container.setVisibility(View.GONE);
                ...
                if (!result.equals("")) {
                    ...
                    rv_policytypelist.setAdapter(new GetLifeInsurParentPolicyTypeListAdapter(context, policyTypeList));
