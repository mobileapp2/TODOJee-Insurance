...
public class GeneralInsuranceCompany_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_generalinsure_company, container, false);
        context = getActivity();
        init(rootView);
        getSessionData();
        setDefault();
...
//            shimmer_view_container.startShimmer();
        ...
        protected String doInBackground(String... params) {
            ...
            param.add(new ParamsPojo("insurance_type_id", "1"));
...
//                shimmer_view_container.setVisibility(View.GONE);
                ...
                if (!result.equals("")) {
                    ...
                    rv_companylist.setAdapter(new GetGeneralInsurCompListAdapter(context, companyList));
