...
public class AddLifeInsurance_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_lifeinsurance);
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(AddLifeInsurance_Activity.this);
    }

    private void init() {
        context = AddLifeInsurance_Activity.this;
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(AddLifeInsurance_Activity.this);
                            }
                        }
                    });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(AddLifeInsurance_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(AddLifeInsurance_Activity.this);
            }
...
//        }
        ...
        if (Utilities.isInternetAvailable(context)) {
            new AddLifeInsuranceDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Add Life Insurance");
    ...
    public class AddLifeInsuranceDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
