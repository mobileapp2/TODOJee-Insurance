...
public class AddGeneralInsurance_Activity extends Activity {
    ...
    private String user_id, companyId, clientId, insurerId, policyTypeID = "0", frequencyId, insurerTypeId, insurerType, is_shared = "0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_generalinsurance);
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(AddGeneralInsurance_Activity.this);
    }

    private void init() {
        context = AddGeneralInsurance_Activity.this;
    ...
    private void setEventHandler() {
        ...
        edt_enddate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Release 1.4 changes - remove mandatory start date
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(AddGeneralInsurance_Activity.this);
                            }
                        }
                    });
...
//        }
        ...
        //hardcode due to removal of frequency dropdown
        ...
        if (Utilities.isInternetAvailable(context)) {
            new AddGeneralInsuranceDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Add General Insurance");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(AddGeneralInsurance_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(AddGeneralInsurance_Activity.this);
            }
...
//        doc_image_uri = Uri.fromFile(imageFile);
    ...
    public class AddGeneralInsuranceDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
