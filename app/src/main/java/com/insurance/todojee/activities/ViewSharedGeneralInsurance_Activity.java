...
public class ViewSharedGeneralInsurance_Activity extends Activity {
    private Context context;
    private TextView tv_insurance_type, tv_insurance_company, tv_client_name, tv_insurer_name, tv_insurance_policy_no, tv_policy_type, tv_startenddate, tv_sum_insured, tv_premium_amt, tv_link, tv_desc, tv_remark, tv_documents, tv_insurance_created_by, tv_insurer_type, tv_enddate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_shared_general_insurance);
        init();
        setUpToolbar();
        getSessionData();
        setDefault();
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Shared General Insurance");
    ...
    private void init() {
        context = ViewSharedGeneralInsurance_Activity.this;
        ...
        tv_insurer_type = findViewById(R.id.tv_insurer_type);
        tv_enddate = findViewById(R.id.tv_enddate);
        documentsLayoutsList = new ArrayList<>();

        lifeInsurancePicFolder = new File(Environment.getExternalStorageDirectory() + "/Insurance/" + "General Insurance");
    ...
    private void setDefault() {
        ...
        tv_insurance_type.setText("General Insurance");
        ...
        if (lifeInsuranceDetails.getInsurer_type_id().equals("R")) {
            tv_insurer_type.setText("Individuals");
            tv_insurer_name.setText(lifeInsuranceDetails.getInsurer_family_name());
        } else if (lifeInsuranceDetails.getInsurer_type_id().equals("F")) {
            tv_insurer_type.setText("Firms");
            tv_insurer_name.setText(lifeInsuranceDetails.getInsurer_firm_name());
        }
        ...
        if (documentsList.size() != 0) {
           /* String docs="";
            for (int i = 0; i < documentsList.size(); i++) {
                 docs = docs + " "+documentsList.get(i).getDocument();
            }
            tv_documents.setText("Documents : "+docs);*/
            //rv_list_documents.setAdapter(new GetDocumentListAdapter(context,documentsList));
            for (int i = 0; i < documentsList.size(); i++) {
