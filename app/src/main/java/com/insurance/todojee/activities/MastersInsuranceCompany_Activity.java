...
public class MastersInsuranceCompany_Activity extends FragmentActivity {
    ...
    private void init() {
        context = MastersInsuranceCompany_Activity.this;
...
//        linearLayout.setDividerDrawable(drawable);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new LifeInsuranceCompany_Fragment(), "Life Insurance");
        adapter.addFrag(new GeneralInsuranceCompany_Fragment(), "General Insurance");
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Insurance Company");
