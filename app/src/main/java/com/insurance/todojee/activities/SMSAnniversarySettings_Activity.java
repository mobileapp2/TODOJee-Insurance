...
public class SMSAnniversarySettings_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sms_anniversary);
    ...
    private void init() {
        context = SMSAnniversarySettings_Activity.this;
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (Utilities.isInternetAvailable(context)) {
                            new AddAnniSMSSettings().execute(edt_smsmessage.getText().toString().trim(), user_id);
                        } else {
                            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                        }
                    }
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Anniversary SMS Setting");
    ...
    public class AddAnniSMSSettings extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            obj.addProperty("type", "addAnniSMSSettings");
