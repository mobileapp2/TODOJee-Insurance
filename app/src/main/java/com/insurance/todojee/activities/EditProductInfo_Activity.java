...
public class EditProductInfo_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_productinfo);
    ...
    protected void onPause() {
        super.onPause();
        hideSoftKeyboard(EditProductInfo_Activity.this);
    }

    private void init() {
        context = EditProductInfo_Activity.this;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(EditProductInfo_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(EditProductInfo_Activity.this);
            }
...
//        doc_image_uri = Uri.fromFile(imageFile);
    ...
    public class EditProductInfo extends AsyncTask<String, Void, String> {
