...
public class WhatsappBirthdaySettings_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whatsapp_birthday);
    ...
    private void init() {
        context = WhatsappBirthdaySettings_Activity.this;
    ...
    private void setEventHandler() {
        ...
        fab_add_whatsappmessage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertDialogBuilder.setTitle("Set Birthday Whatsapp Message");
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Birthday Whatsapp Setting");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(WhatsappBirthdaySettings_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(WhatsappBirthdaySettings_Activity.this);
            }
...
//        doc_image_uri = Uri.fromFile(imageFile);
    ...
    public class AddBirthWhatsAppSettings extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
        ...
        protected String doInBackground(String... params) {
            ...
            obj.addProperty("type", "addBirthWhatsAppSettings");
